...
class FlatInputMaps
{
    static void initInputMaps(final UIDefaults defaults) {
    ...
    private static void initBasicInputMaps(final UIDefaults defaults) {
        ...
        final Object[] bindings = (Object[])defaults.get("PopupMenu.selectedWindowInputMapBindings");
        final Object[] rtlBindings = (Object[])defaults.get("PopupMenu.selectedWindowInputMapBindings.RightToLeft");
        if (bindings != null && rtlBindings != null) {
            final Object[] newBindings = new Object[bindings.length + rtlBindings.length];
    ...
    private static void initTextComponentInputMaps(final UIDefaults defaults) {
        ...
        final Object multiLineInputMap = new LazyInputMapEx(new Object[][] { commonTextComponentBindings, macCommonTextComponentBindings, multiLineTextComponentBindings, macMultiLineTextComponentBindings });
    ...
    private static void initMacInputMaps(final UIDefaults defaults) {
    ...
    private static void modifyInputMap(final UIDefaults defaults, final String key, final Object... bindings) {
        defaults.put(key, new LazyModifyInputMap(((Hashtable<K, Object>)defaults).remove(key), bindings));
    }
    
    private static <T> T mac(final T value, final T macValue) {
        return SystemInfo.IS_MAC ? macValue : value;
    }
    
    private static class LazyInputMapEx implements UIDefaults.LazyValue
    {
        private final Object[][] bindingsArray;
        
        LazyInputMapEx(final Object[]... bindingsArray) {
            this.bindingsArray = bindingsArray;
        }
        
        @Override
        public Object createValue(final UIDefaults table) {
            final InputMap inputMap = new InputMapUIResource();
            for (final Object[] bindings : this.bindingsArray) {
    ...
    private static class LazyModifyInputMap implements UIDefaults.LazyValue
    {
        ...
        LazyModifyInputMap(final Object baseInputMap, final Object[] bindings) {
        ...
        @Override
        public Object createValue(final UIDefaults table) {
            final InputMap inputMap = (InputMap)((this.baseInputMap instanceof UIDefaults.LazyValue) ? ((UIDefaults.LazyValue)this.baseInputMap).createValue(table) : ((InputMap)this.baseInputMap));
            for (int i = 0; i < this.bindings.length; i += 2) {
                final KeyStroke keyStroke = KeyStroke.getKeyStroke((String)this.bindings[i]);
