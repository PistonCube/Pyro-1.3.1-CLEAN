...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable
{
    ...
    public final void resumeWith(@NotNull final Object result) {
        ...
        while (true) {
            ...
            final BaseContinuationImpl $this$with = (BaseContinuationImpl)current;
            final int n = 0;
            final Continuation<Object> completion2 = $this$with.completion;
            if (completion2 == null) {
                Intrinsics.throwNpe();
            }
            ...
            Object o;
            try {
                final Object outcome = $this$with.invokeSuspend(param);
