...
class IntrinsicsKt__IntrinsicsJvmKt
{
    ...
    public static final <T> Continuation<Unit> createCoroutineUnintercepted(@NotNull final Function1<? super Continuation<? super T>, ?> $this$createCoroutineUnintercepted, @NotNull final Continuation<? super T> completion) {
        ...
        if ($this$createCoroutineUnintercepted instanceof BaseContinuationImpl) {
            ...
            final int $i$f$createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt = 0;
            ...
            if (context$iv == EmptyCoroutineContext.INSTANCE) {
                ...
                create = new RestrictedContinuationImpl($captured_local_variable$1, $super_call_param$2, $this$createCoroutineUnintercepted) {
                    private int label;
                ...
                create = new ContinuationImpl($captured_local_variable$2, $captured_local_variable$3, $super_call_param$3, context$iv, $this$createCoroutineUnintercepted) {
                    private int label;
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnintercepted(@NotNull final Function2<? super R, ? super Continuation<? super T>, ?> $this$createCoroutineUnintercepted, final R receiver, @NotNull final Continuation<? super T> completion) {
        ...
        if ($this$createCoroutineUnintercepted instanceof BaseContinuationImpl) {
            ...
            if (context$iv == EmptyCoroutineContext.INSTANCE) {
                ...
                create = new RestrictedContinuationImpl($captured_local_variable$1, $super_call_param$2, $this$createCoroutineUnintercepted, receiver) {
                    private int label;
                ...
                create = new ContinuationImpl($captured_local_variable$2, $captured_local_variable$3, $super_call_param$3, context$iv, $this$createCoroutineUnintercepted, receiver) {
                    private int label;
