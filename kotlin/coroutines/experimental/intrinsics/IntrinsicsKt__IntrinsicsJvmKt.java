...
class IntrinsicsKt__IntrinsicsJvmKt
{
    ...
    @InlineOnly
    private static final <T> Object startCoroutineUninterceptedOrReturn(@NotNull final Function1<? super Continuation<? super T>, ?> $this$startCoroutineUninterceptedOrReturn, final Continuation<? super T> completion) {
        final int $i$f$startCoroutineUninterceptedOrReturn = 0;
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final <R, T> Object startCoroutineUninterceptedOrReturn(@NotNull final Function2<? super R, ? super Continuation<? super T>, ?> $this$startCoroutineUninterceptedOrReturn, final R receiver, final Continuation<? super T> completion) {
        final int $i$f$startCoroutineUninterceptedOrReturn = 0;
        if ($this$startCoroutineUninterceptedOrReturn == null) {
    ...
    @SinceKotlin(version = "1.1")
    @NotNull
    public static final <T> Continuation<Unit> createCoroutineUnchecked(@NotNull final Function1<? super Continuation<? super T>, ?> $this$createCoroutineUnchecked, @NotNull final Continuation<? super T> completion) {
        ...
        if (!($this$createCoroutineUnchecked instanceof CoroutineImpl)) {
            final int $i$f$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt = 0;
            final Continuation<Unit> continuation$iv = new Continuation<Unit>(completion, $this$createCoroutineUnchecked, completion) {
                @NotNull
                @Override
            ...
            final Continuation<Unit> create = ((CoroutineImpl)$this$createCoroutineUnchecked).create(completion);
            if (create == null) {
    ...
    @SinceKotlin(version = "1.1")
    @NotNull
    public static final <R, T> Continuation<Unit> createCoroutineUnchecked(@NotNull final Function2<? super R, ? super Continuation<? super T>, ?> $this$createCoroutineUnchecked, final R receiver, @NotNull final Continuation<? super T> completion) {
        Intrinsics.checkParameterIsNotNull($this$createCoroutineUnchecked, "$this$createCoroutineUnchecked");
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        Object o;
        if (!($this$createCoroutineUnchecked instanceof CoroutineImpl)) {
            final int $i$f$buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt = 0;
            final Continuation<Unit> continuation$iv = new Continuation<Unit>(completion, $this$createCoroutineUnchecked, receiver, completion) {
                @NotNull
                @Override
                public CoroutineContext getContext() {
                    return this.$completion.getContext();
            ...
            final Continuation<Unit> create = ((CoroutineImpl)$this$createCoroutineUnchecked).create(receiver, completion);
            if (create == null) {
                throw new TypeCastException("null cannot be cast to non-null type kotlin.coroutines.experimental.jvm.internal.CoroutineImpl");
            }
            o = ((CoroutineImpl)create).getFacade();
