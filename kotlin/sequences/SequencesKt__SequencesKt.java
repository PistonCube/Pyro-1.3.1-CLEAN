...
class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt
{
    ...
    @InlineOnly
    private static final <T> Sequence<T> orEmpty(@Nullable final Sequence<? extends T> $this$orEmpty) {
    ...
    private static final <T, R> Sequence<R> flatten$SequencesKt__SequencesKt(@NotNull final Sequence<? extends T> $this$flatten, final Function1<? super T, ? extends Iterator<? extends R>> iterator) {
