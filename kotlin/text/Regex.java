...
public final class Regex implements Serializable
{
    ...
    public final Set<RegexOption> getOptions() {
        ...
        if ((options = this._options) == null) {
            ...
            final EnumSet $this$apply$iv;
            final EnumSet set = $this$apply$iv = EnumSet.allOf(RegexOption.class);
            final int n = 0;
            CollectionsKt__MutableCollectionsKt.retainAll((Iterable<?>)$this$apply$iv, (Function1<? super Object, Boolean>)new Function1<T, Boolean>(value$iv) {
                @Override
