...
{
    @InlineOnly
    private static final TimerTask schedule(@NotNull final Timer $this$schedule, final long delay, final Function1<? super TimerTask, Unit> action) {
        final int $i$f$schedule = 0;
    ...
    @InlineOnly
    private static final TimerTask schedule(@NotNull final Timer $this$schedule, final Date time, final Function1<? super TimerTask, Unit> action) {
        final int $i$f$schedule = 0;
        final TimerTask task = (TimerTask)new TimersKt$timerTask.TimersKt$timerTask$1((Function1)action);
    ...
    @InlineOnly
    private static final TimerTask schedule(@NotNull final Timer $this$schedule, final long delay, final long period, final Function1<? super TimerTask, Unit> action) {
        final int $i$f$schedule = 0;
        final TimerTask task = (TimerTask)new TimersKt$timerTask.TimersKt$timerTask$1((Function1)action);
    ...
    @InlineOnly
    private static final TimerTask schedule(@NotNull final Timer $this$schedule, final Date time, final long period, final Function1<? super TimerTask, Unit> action) {
        final int $i$f$schedule = 0;
        final TimerTask task = (TimerTask)new TimersKt$timerTask.TimersKt$timerTask$1((Function1)action);
    ...
    @InlineOnly
    private static final TimerTask scheduleAtFixedRate(@NotNull final Timer $this$scheduleAtFixedRate, final long delay, final long period, final Function1<? super TimerTask, Unit> action) {
        final int $i$f$scheduleAtFixedRate = 0;
        final TimerTask task = (TimerTask)new TimersKt$timerTask.TimersKt$timerTask$1((Function1)action);
    ...
    @InlineOnly
    private static final TimerTask scheduleAtFixedRate(@NotNull final Timer $this$scheduleAtFixedRate, final Date time, final long period, final Function1<? super TimerTask, Unit> action) {
        final int $i$f$scheduleAtFixedRate = 0;
        final TimerTask task = (TimerTask)new TimersKt$timerTask.TimersKt$timerTask$1((Function1)action);
    ...
    private static final Timer fixedRateTimer(final String name, final boolean daemon, final long initialDelay, final long period, final Function1<? super TimerTask, Unit> action) {
        final int $i$f$fixedRateTimer = 0;
        final Timer timer = timer(name, daemon);
