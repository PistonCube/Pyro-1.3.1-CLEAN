...
public final class ThreadsKt
{
    ...
    @InlineOnly
    private static final <T> T getOrSet(@NotNull final ThreadLocal<T> $this$getOrSet, final Function0<? extends T> default) {
        final int $i$f$getOrSet = 0;
        Object value;
        if ((value = $this$getOrSet.get()) == null) {
            final Object p1;
            final Object o = p1 = default.invoke();
            final int n = 0;
            $this$getOrSet.set((T)p1);
            value = o;
        }
        return (T)value;
    }
