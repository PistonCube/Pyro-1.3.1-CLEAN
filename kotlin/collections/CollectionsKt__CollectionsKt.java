...
class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt
{
    ...
    @InlineOnly
    private static final <T> boolean isNotEmpty(@NotNull final Collection<? extends T> $this$isNotEmpty) {
    ...
    @InlineOnly
    private static final <T> boolean isNullOrEmpty(@Nullable final Collection<? extends T> $this$isNullOrEmpty) {
        final int $i$f$isNullOrEmpty = 0;
        return $this$isNullOrEmpty == null || $this$isNullOrEmpty.isEmpty();
    }
    
    @InlineOnly
    private static final <T> Collection<T> orEmpty(@Nullable final Collection<? extends T> $this$orEmpty) {
    ...
    @InlineOnly
    private static final <T> List<T> orEmpty(@Nullable final List<? extends T> $this$orEmpty) {
        final int $i$f$orEmpty = 0;
    ...
    private static final <C extends java.util.Collection, R> R ifEmpty(final C $this$ifEmpty, final Function0<? extends R> defaultValue) {
        ...
        //    StackMapTable: 00 02 FC 00 15 01 40 07 00 CD
        // 
    ...
    @InlineOnly
    private static final <T> boolean containsAll(@NotNull final Collection<? extends T> $this$containsAll, final Collection<? extends T> elements) {
        final int $i$f$containsAll = 0;
