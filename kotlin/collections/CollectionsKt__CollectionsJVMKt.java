...
class CollectionsKt__CollectionsJVMKt
{
    ...
    @InlineOnly
    private static final <T> List<T> toList(@NotNull final Enumeration<T> $this$toList) {
        final int $i$f$toList = 0;
    ...
    private static final Object[] copyToArrayImpl(final Collection<?> collection) {
        final int $i$f$copyToArrayImpl = 0;
    ...
    public static final <T> Object[] copyToArrayOfAny(@NotNull final T[] $this$copyToArrayOfAny, final boolean isVarargs) {
        ...
        if (isVarargs && Intrinsics.areEqual($this$copyToArrayOfAny.getClass(), Object[].class)) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(copy = Arrays.copyOf($this$copyToArrayOfAny, $this$copyToArrayOfAny.length, (Class<? extends Object[]>)Object[].class), "java.util.Arrays.copyOf(\u2026 Array<Any?>::class.java)");
        }
        return copy;
    }
    ...
    private static final int checkIndexOverflow(final int index) {
        final int $i$f$checkIndexOverflow = 0;
        if (index < 0) {
    ...
    private static final int checkCountOverflow(final int count) {
        final int $i$f$checkCountOverflow = 0;
        if (count < 0) {
            if (!PlatformImplementationsKt.apiVersionIsAtLeast(1, 3, 0)) {
