...
class CollectionsKt__MutableCollectionsJVMKt extends CollectionsKt__IteratorsKt
{
    ...
    private static final <T> void sort(@NotNull final List<T> $this$sort, final Comparator<? super T> comparator) {
    ...
    @InlineOnly
    @java.lang.Deprecated
    private static final <T> void sort(@NotNull final List<T> $this$sort, final Function2<? super T, ? super T, Integer> comparison) {
        final int $i$f$sort = 0;
        throw new NotImplementedError(null, 1, null);
    }
    ...
    private static final <T> void fill(@NotNull final List<T> $this$fill, final T value) {
        final int $i$f$fill = 0;
        Collections.fill($this$fill, value);
    }
    
    @InlineOnly
    @SinceKotlin(version = "1.2")
    private static final <T> void shuffle(@NotNull final List<T> $this$shuffle) {
        final int $i$f$shuffle = 0;
        Collections.shuffle($this$shuffle);
    }
    
    @InlineOnly
    @SinceKotlin(version = "1.2")
    private static final <T> void shuffle(@NotNull final List<T> $this$shuffle, final Random random) {
        final int $i$f$shuffle = 0;
